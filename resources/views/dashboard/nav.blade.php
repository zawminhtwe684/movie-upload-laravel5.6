@auth
    <div class="aside-left bg-white px-3 pb-2 min-vh-100 shadow">
        <ul class="menu" style="list-style-type: none">
            ...
            @component("component.nav-item")
                @slot("icon") <i class="fas feather-layers"></i> @endslot
                @slot("name") Category Manager @endslot
                @slot("link") {{ route("category.index") }} @endslot
            @endcomponent

            @component("component.nav-item")
                @slot("icon") <i class="fas feather-plus-circle"></i> @endslot
            ...
            @component("component.nav-item")
                ...
                @slot("name") Server @endslot
                @slot("link") {{ route("server.index") }} @endslot
            @endcomponent

            @component("component.nav-item")
                @slot("icon") <i class="feather-plus-circle"></i> @endslot
                @slot("name") Post Create @endslot
